...
async publishCarousel(caption, mediaUrls, accessToken, config) {
  try {
    ...
    // ✅ CRITICAL FIX: Wait for carousel container to process
    this.log("⏳ Waiting for carousel container to be ready...");
    await this.waitForMediaProcessing(carouselId, accessToken, config, 60000);
    this.log("✅ Carousel container is ready");

    // Step 4: Publish carousel
    this.log("📤 Publishing carousel to Instagram...");
